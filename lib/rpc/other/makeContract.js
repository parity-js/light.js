 ...
 */
var getContract = memoizee(function (address, abiJson) { return api_1.default().newContract(abiJson, address); }, { length: 1 } // Only memoize by address
);
/**
 * Create a contract.
 *
 ...
 * function resolves.
 */
exports.makeContract$ = memoizee(function (address, abiJson) {
    var abi = new Abi(abiJson);
