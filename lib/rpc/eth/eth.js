...
var accounts$ = (0, _createRpc.default)({
  ...
  return (0, _getFrequency.default)(accounts$).pipe((0, _operators2.addToOverview)(accounts$));
});
/**
...
var height$ = (0, _createRpc.default)({
  ...
  return (0, _getFrequency.default)(height$).pipe((0, _operators2.addToOverview)(height$));
});
/**
...
var syncing$ = (0, _createRpc.default)({
  ...
  return (0, _getFrequency.default)(syncing$).pipe((0, _operators2.distinctReplayRefCount)(), (0, _operators2.addToOverview)(syncing$));
});
