...
var accounts$ = (0, _createRpc.default)({
  calls: ['eth_accounts'],
  priority: [_frequency.onAccountsChanged$]
})(function () {
  return (0, _getPriority.default)(accounts$).pipe((0, _operators2.addToOverview)(accounts$));
});
/**
...
var balanceOf$ = (0, _createRpc.default)({
  ...
  priority: [_frequency.onEvery2Blocks$, _frequency.onStartup$]
})(function (address) {
  return (0, _getPriority.default)(balanceOf$).pipe((0, _operators2.switchMapPromise)(function () {
...
var height$ = (0, _createRpc.default)({
  ...
  return (0, _getPriority.default)(height$).pipe((0, _operators2.addToOverview)(height$));
});
/**
...
var syncing$ = (0, _createRpc.default)({
  priority: [_frequency.onSyncingChanged$]
})(function () {
  return (0, _getPriority.default)(syncing$).pipe((0, _operators2.distinctReplayRefCount)(), (0, _operators2.addToOverview)(syncing$));
});
