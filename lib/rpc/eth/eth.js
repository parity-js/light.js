...
exports.syncing$ = exports.me$ = exports.blockNumber$ = exports.height$ = exports.defaultAccount$ = exports.balanceOf$ = exports.accounts$ = void 0;
...
var syncing$ = (0, _createRpc.default)({
  calls: ['eth_syncing'],
  priority: [_priorities.onEverySecond$]
})(function () {
  return (0, _getPriority.getPriority)(syncing$).pipe((0, _operators2.switchMapPromise)(function () {
    return (0, _api.default)().eth.syncing();
  }), (0, _operators2.distinctReplayRefCount)(), (0, _operators2.addToOverview)(syncing$));
});
