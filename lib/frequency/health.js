 ...
 */
exports.onNodeHealthChanged$ = createOnFromPubsub_1.default('parity_nodeHealth', api_1.default);
exports.onNodeHealthChanged$.metadata = { name: 'onNodeHealthChanged$' };
/**
 * Observable that emits when syncing status changes.
 */
exports.onSyncingChanged$ = createOnFromPubsub_1.default('eth_syncing', api_1.default);
exports.onSyncingChanged$.metadata = {
