 ...
 */
exports.onEveryBlock$ = createOnFromPubsub_1.default('eth_blockNumber', api_1.default, {
    name: 'onEveryBlock$'
}).pipe(operators_1.map(function (v) { return +v; }) // Return number instead of BigNumber
);
/**
