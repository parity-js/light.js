  ...
  Object.assign(window.parity, {
    rpcOverview: function rpcOverview() {
      ...
      Object.keys(rpc).forEach(function (key) {
        ...
        overview[key] = _objectSpread({}, rpc$.metadata); // We remove all the metadata keys that are null, empty or functions,
        ...
        if (overview[key].frequency) {
          overview[key].frequency.forEach(function (value, index) {
