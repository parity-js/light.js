...
exports.post$ = exports.nodeHealth$ = exports.chainName$ = exports.accountsInfo$ = void 0;
...
var accountsInfo$ = (0, _createRpc.default)({
  ...
  return (0, _getPriority.getPriority)(accountsInfo$).pipe((0, _operators2.switchMapPromise)(function () {
    return (0, _api.default)().parity.accountsInfo();
  }), (0, _operators.map)(function (accountsInfo) {
    Object.keys(accountsInfo).forEach(function (address) {
    ...
    return accountsInfo;
  }), (0, _operators2.distinctReplayRefCount)(), (0, _operators2.addToOverview)(accountsInfo$));
});
/**
