...
var createRpc = function createRpc() {
  ...
  return function (source$) {
    var rpc$ = function rpc$() {
      ...
      (_source$ = source$.apply(void 0, args)).pipe.apply(_source$, pipes).subscribe(subject$); // Add a field in the calledWith object, so that we know this function has
      ...
      metadata.calledWith[(0, _jsonPrune.default)(args)] = subject$;
      return subject$;
    };
