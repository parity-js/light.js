...
exports.accounts$ = createRpc_1.default({
  ...
  return getFrequency_1.default(exports.accounts$);
});
/**
...
exports.balanceOf$ = createRpc_1.default({
  ...
  return getFrequency_1.default(exports.balanceOf$).pipe(
    operators_2.switchMapPromise(function() {
      return api_1.default().eth.getBalance(address);
    })
  );
});
/**
...
exports.defaultAccount$ = createRpc_1.default({
  ...
  return exports.accounts$().pipe(
    operators_1.map(function(accounts) {
      return accounts[0];
    })
  );
});
 ...
 */
exports.height$ = createRpc_1.default({
 ...
 * @return {Observable<Number>} - An Observable containing the block height.
 */
exports.blockNumber$ = createRpc_1.default({ dependsOn: ['height$'] })(
  function() {
...
exports.myBalance$ = createRpc_1.default({
  ...
  return exports.defaultAccount$().pipe(
    operators_1.switchMap(function(defaultAccount) {
...
exports.syncing$ = createRpc_1.default({
  ...
  return getFrequency_1.default(exports.syncing$);
});
